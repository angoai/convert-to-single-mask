...
def polygon_to_single_mask(api_key: str, project_id: str, json_path: str, output_folder: str = 'masks', class_mapping_type: str = 'multi_channel_qualitative'):
    ...
    # Convert Polygons to Single Mask
    for current_data in data:
        ...
        if class_mapping_type in ['single_channel_sequential', 'single_channel_diverging']:
            ...
            for obj_ind, obj in enumerate(objects):
                ...
                instance_mask_array = cv2.fillPoly(instance_mask_array, pts=[polygon], color=(class_mapping[class_name]))
            ...
            for obj_ind, obj in enumerate(objects):
                ...
                instance_mask_array = cv2.fillPoly(instance_mask_array, pts=[polygon], color=color_int)
